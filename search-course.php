                                ...
                                <div class="row top-content">
                                    <div class="col-md-3">
                                        <div class="result-output text-left">
                                            <p class="result-count">Showing <strong>1-6</strong> of total <strong>12</strong> courses</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="tab-content courses-content">
                                    <div id="campus" role="tabpanel" class="tab-pane fade in active">
                                        <div class="style-show style-grid row">
                                            ...
                                            $sele = "SELECT * FROM course WHERE category=$category";
                                                        ...
                                                        <div class="edugate-layout-2-wrapper">
                                                            <div class="edugate-content"><a href="course-detail.php?get=<?= $course['id']; ?>" class="title"><?= $course['name']; ?></a>
                                                                <div class="info">
                                                                    ...
                                                                    <div class="date-time item"><a href="#"><?= $course['add_time']; ?></a></div>
                                                                </div>
                                                                <div class="info-more">
