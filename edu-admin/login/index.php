...
<head>
    ...
    <style>
        ...
        .div>ul>li:nth-child(2)>label::before {
            content: "Edugate Site Settings Can do changes your site logo, email, mobile, facebook, instagram, twitter,linkedin, address and page title.";
            top: 0;
        }

        .div>ul>li:nth-child(4)>label::before {
            content: "Edugate slider settings have you can change slider image, button link, heading ,paragraph, description and also add and delete sliders and search images. ";
            top: -50px;
        }

        .div>ul>li:nth-child(6)>label::before {
            content: "Edugate gallery settings have you can change gallery image, heading, description, and add or  delete gallery images and show home and check popular images and search images .";
        }
        ...
        .div>ul>li:nth-child(8)>label::before {
            content: "Edugate courses settings have you can change course image, heading, description, and add or delete course images and show home and check popular images and search images add new course delete exixting course.";

        }

        .div>ul>li:nth-child(10)>label::before {
            top: -120px;
            content: "Edugate blogs settings have you can change blog image, heading, details, description, and add or delete blogs images and show home and check popular images and search images add new blogs delete exixting blogs!";
        ...
        .div>ul>li:nth-child(12)>label::before {
            top: unset;
            bottom: 0;
            content: "Edugate testimonials settings have you can change testimonials image, heading, description, and add or delete testimonials images and search images add new testimonials delete exixting course.";
    ...
    <div class="wrapper">
        ...
        <div class="container-fluid mt-15">
            ...
            <div class="card-body bg-white">
                <h1 class="text-center text-success mb-50">WELCOME TO EDUGATE ADMIN</h1>
