...
if(isset($_POST["testimg"])){
        $idimg=$_POST['id'];
    $updatetime = date("Y-m-d h:i:s:a");
       $filename = $_FILES['img']["name"];
        $tmpname = $_FILES["img"]["tmp_name"];
        $updateimg="UPDATE testimonials SET image=:img,modify_time=:ti WHERE id=:uimg";
        ...
        $query->execute();
         ...
         if($uploaded){
        echo "<script>alert('IMGAGE UPDATED');window.location.href='testimonial.php';</script>";
         }
}
    if (isset($_POST["testupdate"])) {
        ...
        $uid=$_POST["id"];     
            ...
            $insert = "UPDATE testimonials SET name=:name,designation=:desig,description=:de,status=:st,modify_time=:ti WHERE id=:uid";
            ...
            echo "<script>alert('DATA MDIFIED');window.location.href='testimonial.php';</script>";
...
if (isset($_GET["did"])) {
    $did = $_GET["did"];
    $delete = "DELETE FROM testimonials WHERE id=:did";
    ...
    <div class="wrapper">
        ...
        <div class="card-body">
            <div class="bg-white p-50" id="not">
                <h2 class="text-center mb-50 text-primary">TESTIMONIALS</h2>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img height="200" width="200" src="images/testimonials/<?php echo $val["image"]; ?>"></td>
                                ...
                                <td><a href="testimonial.php?eid=<?php echo $val['id']; ?>" class="text-primary">EDIT</a></td>
                                <td><a href="testimonial.php?did=<?php echo $val['id']; ?>" onclick="return confirm('ARE YOU SURE TO DELETE')" class="text-danger">DELETE</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
...
<?php if(isset($_GET["eid"])){
    ...
    $selectid="SELECT * FROM testimonials WHERE id=:eid";
...
?>
        ...
        <div class="card-body" > 
            ...
            <form class="form-horizontal bg-white p-50" method="POST" enctype="multipart/form-data">
                <a href="testimonial.php" class="avatar avatar-md bg-light text-muted float-right">X</a>
...
<div class="col-md-6"><button type="submit" class="btn btn-warning m-20" name="testimg">UPDATE IMAGE</button></div>


                    </div>
                                                                     
                    <div class="col-md-5 col-sm-12 col-xs-12 px-15">
                        <img class="float-right mr-50" height="200" width="300px" src="images/testimonials/<?php echo $e['image']; ?>">
                    </div>
                </div>
                ...
                <div class="mb-15 row mt-50">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" placeholder="Testimonial Name" name="name" 
                        value="<?=$e["name"]; ?>">
                    </div>
                </div>
                <div class="mb-15 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="desig" placeholder="Testimonials designation" name="desig" value="<?=$e["designation"]; ?>">
                    </div>
                </div>
                ...
                <div class="mb-15 row">
                    ...
                    <div class="col-sm-9">
                        <textarea rows="10" id="desc" class="form-control" placeholder="Testimonials description" name="desc"> <?=$e["description"]; ?></textarea>
                    </div>
                </div>
                ...
                <div class="my-50 justify-content-end row">
                    <div class="col-md-3"><button type="submit" class="btn btn-success" name="testupdate">UPDATE TESTIMONIAL</button></div>
                    <div class="col-md-2"><button type="button" class="btn btn-danger float-right"  onclick="window.location.href='testimonial.php';">close</button></div>
                </div>
            </form>
        </div>
